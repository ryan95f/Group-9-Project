    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(related_name='book_set', blank=True, to='core.Module', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='BookNode',
        ...
        migrations.AddField(
            model_name='book',
            name='tree',
            field=models.ForeignKey(related_name='book_set', to='core.BookNode', null=True),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
