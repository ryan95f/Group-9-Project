...
% The following is required for Software Architecture -> Class Diagram:
\usepackage[
% school,
% simplified
]{pgf-umlcd}

% The following is required for Implementation -> Algorithm Design:
\usepackage{listings}
\newcommand*{\custpythonlstinputlisting}[1]{
	\begin{center}
		\lstinputlisting[
		breaklines=true,
		language=Python,
...
% Allows us to create more readible references:
\usepackage{hyperref}
