\subsection{System Components}
	...
	\subsubsection{Components}
		...
		After an extensive study into the system's current state and its requirements, we have briefly identified the following possible applications for our system's Django project to be as follows:
		
		Please note: this is just a brief outline as to the functionality of each application and some ambiguities do exist. However, we can rest-assured as progress shall be upon these later on, when we develop a more concise view of the structure for our system to-be.
