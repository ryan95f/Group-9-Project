...
\resizebox{.95\textwidth}{!}{
	\begin{tikzpicture}
		\begin{package}{Nodes}
			\begin{abstractclass}[text width=8cm]{LeafNode}{-1,0}
			...
			\begin{abstractclass}[text width=5cm]{TextNode}{4.5,-8}
				\inherit{LeafNode}
			...
			\begin{abstractclass}[text width=8cm]{Node}{-5,-8}
				\inherit{LeafNode}
			...
			\begin{abstractclass}[text width=5cm]{ArgumentNode}{4.5,-14}
				\inherit{Node}
				
				\operation{\_\_init\_\_(children : LeafNode[0..*])}
			\end{abstractclass}
			
			\begin{abstractclass}[text width=5cm]{CommandNode}{-6.5,-17}
				\inherit{Node}
			...
			\begin{abstractclass}[text width=5cm]{EnvironmentNode}{-1,-17}
				\inherit{Node}
			...
			\begin{abstractclass}[text width=5cm]{LevelNode}{4.5,-17}
				\inherit{Node}
